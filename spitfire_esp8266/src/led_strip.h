...
void setup_strip(void) {
  ...
  Brightness_B = 0;
	...
	// with set_leds (Brightness_R, Brightness_G, Brightness_B); ,which I've already done, these number 
...
void update_strip(void) {
	...
	set_leds(Brightness_R, Brightness_G, Brightness_B);
	// if (ColorValue == 0) {set_leds (Brightness_R, Brightness_G, Brightness_B);} // default to fade pattern
	// if (ColorValue == 1) {set_leds (255, 0, 0);}  // LED strip red
	// if (ColorValue == 2) {set_leds (0, 255, 0);}  // LED strip green
	// if (ColorValue == 3) {set_leds (0, 0, 255);}  // LED strip blue
